...
export default {
    ...
    profile: {
        ...
        avatar: {
            ...
            saveFailed: '更新頭像風格失敗',
            tabBadge: '勳章',
            tabStyle: 'DiceBear 風格',
            tabCustomUrl: '自訂圖片',
            badgeApplied: '目前已應用勳章作為頭像。',
            badgeNotApplied: '尚未應用勳章作為頭像。',
            noBadge: '暫無勳章',
            manageBadges: '管理勳章',
            urlLabel: '圖片連結',
            urlInvalid: '僅允許 https://cdn.nodeimage.com/i/*.jpeg/jpg/png/webp 格式的圖片',
            urlValid: '圖片連結格式正確',
            urlHint: '僅支援 https://cdn.nodeimage.com/i/ 路徑下的圖片。請使用 https://www.nodeimage.com/ 圖床。',
            urlSaveSuccess: '自訂頭像已更新',
            urlSaveFailed: '更新自訂頭像失敗',
            urlCleared: '已清除自訂頭像',
            currentCustom: '目前自訂圖片',
            clearUrl: '清除自訂頭像',
            styles: {
                adventurer: '冒險者',
