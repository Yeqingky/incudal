export default {
    ...
    profile: {
        ...
        avatar: {
            ...
            tabBadge: 'Badge',
            tabStyle: 'DiceBear Style',
            tabCustomUrl: 'Custom Image',
            badgeApplied: 'A badge is currently applied as your avatar.',
            badgeNotApplied: 'No badge is applied as your avatar.',
            noBadge: 'No Badge',
            manageBadges: 'Manage Badges',
            urlLabel: 'Image URL',
            urlInvalid: 'Only https://cdn.nodeimage.com/i/*.jpeg/jpg/png/webp images are allowed',
            urlValid: 'Valid image URL',
            urlHint: 'Only images from the https://cdn.nodeimage.com/i/ path are supported. Please use the https://www.nodeimage.com/ image hosting service.',
            urlSaveSuccess: 'Avatar image updated',
            urlSaveFailed: 'Failed to update avatar image',
            urlCleared: 'Custom avatar image removed',
            currentCustom: 'Current custom image',
            clearUrl: 'Remove Custom Image',
            styles: {
