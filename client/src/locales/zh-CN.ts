export default {
    ...
    profile: {
        ...
        avatar: {
            ...
            saveFailed: '更新头像风格失败',
            tabBadge: '勋章',
            tabStyle: 'DiceBear 风格',
            tabCustomUrl: '自定义图片',
            badgeApplied: '当前已应用勋章作为头像。',
            badgeNotApplied: '尚未应用勋章作为头像。',
            noBadge: '暂无勋章',
            manageBadges: '管理勋章',
            urlLabel: '图片链接',
            urlInvalid: '仅允许 https://cdn.nodeimage.com/i/*.jpeg/jpg/png/webp 格式的图片',
            urlValid: '图片链接格式正确',
            urlHint: '仅支持 https://cdn.nodeimage.com/i/ 路径下的图片。请使用 https://www.nodeimage.com/ 图床。',
            urlSaveSuccess: '自定义头像已更新',
            urlSaveFailed: '更新自定义头像失败',
            urlCleared: '已清除自定义头像',
            currentCustom: '当前自定义图片',
            clearUrl: '清除自定义头像',
            styles: {
                adventurer: '冒险者',
